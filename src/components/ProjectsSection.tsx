...
const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      name: "CosmoX",
      year: "2021",
      link: "https://play.google.com/store/apps/details?id=com.coder.cosmox",
  ...
  return (
    <section id="projects" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16">
          <h3 className="text-2xl font-bold mb-8 text-navy">Co-curricular Activities</h3>
          
          <div className="grid md:grid-cols-3 gap-6">
            {activities.map((activity, index) => (
              <div 
                key={index} 
                className="bg-white p-6 rounded-lg shadow-md border-l-4 border-green-500 animate-slide-in"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
